...
1. On occasion, one sees multiple different terms used to refer to a similar thing e.g. charge density wave, charge order, and stripes. If these really refer to the same thing, it is better to just use one term. If you want to convey a distinction, be sure to include clear explanations or your meaning might well be lost or worse still you may actively confuse people.
...
1. Jourals sometimes insist that you do not use terms like "new", "novel", "unique", "for the first time". We do not dislike these words per se, but we urge care when using these words. Make sure that you are not just stating that your work is "novel" lazy way to avoid explaining why your work is novel. If you have a clear explanation novelty, you may find that stating "novely" is unnecessary.
